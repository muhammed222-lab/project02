...
$freelancers = $conn->query("SELECT * FROM users WHERE role = 'Freelancer'");
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="container mx-auto mt-8">
        ...
        <table class="min-w-full border border-gray-300 mt-4">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr>
                    <td class="px-4 py-2 whitespace-nowrap"><?php echo htmlspecialchars($freelancer['name']); ?></td>
                    <td class="px-4 py-2 whitespace-nowrap"><?php echo htmlspecialchars($freelancer['email']); ?></td>
                    <td class="px-4 py-2 text-center">
                        <button onclick="viewUserDetails(<?php echo htmlspecialchars(json_encode($freelancer)); ?>)"
