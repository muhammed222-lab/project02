...
<body class="antialiased">
    ...
    <main class="container mx-auto px-4 py-16 max-w-7xl">
        <header class="mb-12 text-center">
            ...
            <p class="text-xl text-gray-600 max-w-2xl mx-auto">Explore the projects that have caught your eye. Review details, contact creators, and take the next step towards your goals.</p>
        </header>
        ...
        <div class="bg-white rounded-2xl shadow-xl p-16 text-center">
            <div class="max-w-md mx-auto">
                ...
                <p class="text-gray-600 mb-8">Explore our project marketplace and find projects that spark your interest. Your journey starts here!</p>
