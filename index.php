...
<body class="antialiased">
    ...
    <!-- Navigation -->
    <nav class="fixed w-full z-50 top-0 left-0 right-0 bg-[var(--bg-primary)]/95 backdrop-blur-xl border-b border-[var(--accent-color)]/30 shadow-lg">
        <div class="container mx-auto px-8 py-4">
            <div class="flex justify-between items-center">
                <a href="index.php" class="flex items-center space-x-3 group">
                    <img src="./favicon.png" alt="P02" class="w-10 h-10 rounded-2xl transform transition-all duration-300 group-hover:rotate-12 group-hover:scale-110">
                    <span class="text-2xl font-bold text-[var(--accent-color)]">PROJECT 02</span>
                </a>
                <div class="flex items-center space-x-6">
                    <a href="login.php" class="text-white text-base font-semibold px-5 py-2 rounded-full hover:text-[var(--accent-color)] transition-all duration-300 hover:-translate-y-1 hover:bg-[var(--accent-color)]/10">
                        Login
                    </a>
                    <a href="signup.php" class="bg-[var(--accent-color)] text-black text-base font-semibold px-6 py-2 rounded-full transform transition-all duration-300 hover:scale-105 hover:bg-white hover:shadow-[0_0_20px_rgba(0,229,255,0.3)] hover:-translate-y-1 relative overflow-hidden">
    ...
    <header class="min-h-screen flex items-center relative overflow-hidden hero-background">
        <div class="container mx-auto px-6 relative z-10">
            <div class="max-w-4xl mx-auto text-center">
                ...
                <div class="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-6" data-aos="fade-up" data-aos-delay="200">
                    <a href="signup.php" class="btn-primary px-8 py-4 rounded-xl text-lg font-semibold shadow-xl hover:shadow-[var(--accent-primary)]/30">
                        Start Your Journey
                    </a>
                    <a href="#features" class="px-8 py-4 rounded-xl text-lg font-semibold border-2 border-[var(--accent-primary)] hover:bg-[var(--accent-primary)]/10 transition-colors">
                        Explore Features
                    </a>
                </div>
            </div>
        ...
        <div class="absolute bottom-1/4 right-10 w-32 h-32 bg-[var(--accent-secondary)]/20 rounded-full blur-xl float" style="animation-delay: -2s"></div>
    </header>
        ...
        <div class="container mx-auto px-6">
            <div class="flex flex-col md:flex-row items-center gap-12">
                <div class="md:w-1/2" data-aos="fade-right">
                    ...
                    <div class="space-y-6">
                        <p class="text-[var(--text-secondary)] text-lg leading-relaxed">
                            We're not just another project marketplace. We're a comprehensive platform designed to transform your academic journey.
                        </p>
                        <ul class="space-y-4">
                ...
                <div class="md:w-1/2" data-aos="fade-left">
                    <div class="relative">
                        <div class="absolute inset-0 bg-gradient-to-r from-[var(--accent-primary)] to-[var(--accent-secondary)] opacity-20 blur-2xl rounded-3xl"></div>
                        <img src="./assets/images/hero2.jpg" alt="Platform Features" class="relative rounded-3xl shadow-2xl">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="py-20 glass">
        <div class="container mx-auto px-6 text-center">
            <h2 class="text-4xl font-bold mb-12 text-[var(--accent-color)]" data-aos="fade-up">Trusted by Students & Institutions</h2>
            <div class="grid grid-cols-2 md:grid-cols-4 gap-8" data-aos="fade-up" data-aos-delay="100">
                <div class="p-6">
                    <img src="./assets/images/done.png" alt="Trust 1" class="w-24 h-24 mx-auto filter grayscale hover:grayscale-0 transition-all">
                </div>
                <div class="p-6">
                    <img src="./assets/images/done2.png" alt="Trust 2" class="w-24 h-24 mx-auto filter grayscale hover:grayscale-0 transition-all">
                </div>
                <div class="p-6">
                    <img src="./assets/images/control.png" alt="Trust 3" class="w-24 h-24 mx-auto filter grayscale hover:grayscale-0 transition-all">
                </div>
                <div class="p-6">
                    <img src="./assets/images/connect.png" alt="Trust 4" class="w-24 h-24 mx-auto filter grayscale hover:grayscale-0 transition-all">
                </div>
            </div>
        </div>
    </section>
    ...
    <!-- Cookie Consent -->
    <div id="cookieConsent" class="fixed bottom-5 right-5 max-w-md glass rounded-2xl p-6 z-50 transform transition-transform duration-500 translate-y-full opacity-0">
        <h3 class="text-lg font-semibold mb-3 text-[var(--accent-color)]">🍪 Cookie Preferences</h3>
        <p class="text-[var(--text-secondary)] text-sm mb-4">
            We use cookies to enhance your experience. By continuing, you agree to our use of cookies.
            <a href="./terms.php" class="text-[var(--accent-primary)] hover:underline">Learn more</a>
        </p>
        <div class="flex space-x-4">
            <button id="acceptCookies" class="btn-primary px-4 py-2 rounded-xl">
                Accept All
            </button>
            <button id="denyCookies" class="px-4 py-2 border border-[var(--accent-primary)] rounded-xl hover:bg-[var(--accent-primary)]/10 transition-colors">
                Reject All
            </button>
        </div>
    </div>
